...
def SynthesisParameters_setFadeTime(t):
    r"""
...
def SynthesisParameters_setSampleRate(rate):
    r"""
...
def SynthesisParameters_setFilterCoefs(num, den):
    r"""
...
def Channelizer_computeStretchFactor(fm, m, fn, n):
    r"""
